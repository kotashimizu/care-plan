...
## 支援目標設定における多角的視点の統合
各支援領域の目標設定では、以下の複数視点を統合して質の高い支援計画を作成してください：
- **強み活用視点**: 本人の得意分野・興味関心を活かしたアプローチ
- **課題解決視点**: 困難な分野を段階的に改善するアプローチ
- **環境調整視点**: 支援方法・環境設定を工夫するアプローチ
- **関係性構築視点**: 対人関係・社会参加を促進するアプローチ
...

{
  ...
  "supportGoals": {
    "employment": {
      ...
      "objective": "本人の強み・課題・環境を多角的に分析し、統合的アプローチによる就労能力向上の具体的で測定可能な目標を80文字程度で設定してください。",
      "supportContent": "強み活用・課題解決・環境調整を組み合わせた障害特性に応じた支援内容・提供上のポイントを80文字程度で記載してください。",
    ...
    "dailyLife": {
      ...
      "objective": "本人の生活状況・強み・課題を多角的に分析し、統合的アプローチによる日常生活技能向上の具体的で測定可能な目標を80文字程度で設定してください。",
      "supportContent": "強み活用・段階的改善・環境整備を組み合わせた個別アセスメントに基づく支援内容・提供上のポイントを80文字程度で記載してください。",
      "achievementPeriod": "目標達成の具体的時期（令和○年○月○日まで等）",
    ...
    "socialLife": {
      ...
      "objective": "本人の社会性・対人関係・参加状況を多角的に分析し、統合的アプローチによる社会生活技能向上の具体的で測定可能な目標を80文字程度で設定してください。",
      "supportContent": "関係性構築・参加促進・環境調整を組み合わせたソーシャルスキル向上のための支援内容・提供上のポイントを80文字程度で記載してください。",
      "achievementPeriod": "目標達成の具体的時期（令和○年○月○日まで等）",
