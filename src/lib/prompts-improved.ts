...

{
  ...
  "supportGoals": {
    "employment": {
      ...
      "supportContent": "本人の希望を実現するために、支援者が『〜を支援します』『〜のサポートを行います』という形式で、具体的な支援内容と留意事項を80文字程度で記載してください。",
      "supportPeriod": "支援の頻度・時間・期間を具体的に記載（例：月〜金 10:00〜15:00、令和○年○月まで）",
      "provider": "担当者名と役職（例：山田太郎（職業指導員））",
      "priority": "1"
    },
    "dailyLife": {
      ...
      "userRole": "本人が取り組む内容を『〜します』『〜に取り組みます』という形式で、具体的な行動を80文字程度で記載してください。",
      "supportContent": "本人の希望を実現するために、支援者が『〜を支援します』『〜のサポートを行います』という形式で、具体的な支援内容と留意事項を80文字程度で記載してください。",
      "supportPeriod": "支援の頻度・時間・期間を具体的に記載（例：毎日 13:00〜、3ヶ月間）",
      "provider": "担当者名と役職（例：鈴木花子（生活支援員））",
      "priority": "2"
    },
    "socialLife": {
      ...
      "userRole": "本人が取り組む内容を『〜します』『〜に取り組みます』という形式で、具体的な行動を80文字程度で記載してください。",
      "supportContent": "本人の希望を実現するために、支援者が『〜を支援します』『〜のサポートを行います』という形式で、具体的な支援内容と留意事項を80文字程度で記載してください。",
      "supportPeriod": "支援の頻度・時間・期間を具体的に記載（例：週2回 グループ活動時）",
      "provider": "担当者名と役職（例：佐藤一郎（生活支援員））",
      "priority": "3"
    }
  },
  "qualityScore": {
